...
const imageSchema = mongoose.Schema({
    ...
    hrloastart: {type:Number, required:false},
    hrloaend: {type:Number, required:false},
    ...
    isbiometric:{type:String, required:false},
    lang:  {type:Number, required:false},
    appalt: {type:Number, required:false},
    susbiotrk: {type:Array, "default":[]},
    make: {type:String, required:false},
    model: {type:String, required:false},
    osver: {type:String, required:false},
    wellness: {type:String, required:false},
    showtemperature : {type:String, required:false}
